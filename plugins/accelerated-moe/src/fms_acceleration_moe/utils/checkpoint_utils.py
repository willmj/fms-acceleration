...
def recover_original_state_dict_from_dcp_checkpoint(
    ...
    def load_sharded_safetensors(sharded_files):
        """
        Loads a state dictionary from sharded safetensors files.
        
        Parameters:
        - sharded_files: List of paths to the sharded safetensors files.

        Returns:
        - state_dict: A PyTorch state dictionary.
        """
        state_dict = {}
